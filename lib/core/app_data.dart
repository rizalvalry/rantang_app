...
import 'package:e_commerce_flutter/src/model/poin_product.dart';
...
class AppData {
  ...
  //   Icons.home, Colors.white,
  //   Icons.favorite, Colors.white,
  //   Icons.shopping_cart, Colors.white,
  //   Icons.person, Colors.white
  // ];

  static List<Widget> iconWidgetList = [
    ...
    Icon(Icons.person, color: Colors.white),
     ...
     static List<String> titles = ['Home', 'Search', 'Favorite', 'Profile'];
  ...
  static List<PointProduct> pointProducts = [
    PointProduct(
      imagePath: 'assets/images/Voucher1.png',
      keterangan: 'Berlaku Hingga',
      cardBackgroundColor: const Color(0xFFEC6813),
    ),
    PointProduct(
    ...
    PointProduct(
      ...
      keterangan: 'Berlaku Hingga',
      cardBackgroundColor: Color.fromARGB(255, 71, 220, 108),
    ),
  ];
}
